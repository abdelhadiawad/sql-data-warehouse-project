...
- **[Visual Studio Code (VS Code)](https://code.visualstudio.com/):** Code editor used for writing and executing SQL scripts and managing the data warehouse development workflow.
- **[Docker](https://www.docker.com/):** Used to run and host the SQL Server database in a containerized environment.
